      ...
      <header className="border-b border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-900">
        <div className="mx-auto max-w-5xl px-4 py-4">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h1 className="text-lg font-bold text-zinc-900 dark:text-zinc-50">MercadoTCG</h1>
              <p className="text-xs text-zinc-400">Comparador de preços Pokémon TCG</p>
            </div>
      ...
      <main className="mx-auto max-w-5xl px-4 py-6">
        ...
        {!loading && !error && !result && (
          <div className="flex flex-col items-center justify-center gap-2 py-24 text-center">
            <p className="text-zinc-400 text-sm">Selecione um set e informe o número da carta para buscar preços.</p>
          </div>
        )}
      </main>
    </div>
